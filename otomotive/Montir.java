...
public class Montir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("News Gothic MT", 1, 14)); // NOI18N
        jLabel2.setText("USERNAME");

        jLabel3.setFont(new java.awt.Font("News Gothic MT", 1, 14)); // NOI18N
        jLabel3.setText("PASSWORD");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mechanic-153736_640(2).png"))); // NOI18N
        ...
        jButton_masuk.setFont(new java.awt.Font("News Gothic MT", 0, 12)); // NOI18N
        jButton_masuk.setText("Sign In");
        ...
        jButton_reg.setFont(new java.awt.Font("News Gothic MT", 0, 12)); // NOI18N
        jButton_reg.setText("Sign Up");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jButton_masuk, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(49, 49, 49)
                        .addComponent(jButton_reg, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField_usname, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE))))
                .addGap(42, 42, 42))
    ...
    private void jButton_masukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_masukActionPerformed
        ...
        String query = "SELECT * FROM `akun_pembeli` WHERE 'username_pembeli' = ? AND 'password' = ?";
        
        try {
            st = koneksi_saya.getConnection().prepareStatement(query);
            ...
            if(ss.next()){
                ...
                if((username.equals("admin")) && (password.equals("admin"))){
                    ...
                    Pembelian customer = new Pembelian();
            ...
            Logger.getLogger(Montir.class.getName()).log(Level.SEVERE, null, ex);
        }
